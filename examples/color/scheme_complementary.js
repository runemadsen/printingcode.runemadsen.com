---
layout: example
title: "Color scheme: Complementary"
description: "Creating a complementart color scheme with HSV"
---
...
var square2 = square1.copy().move(200, 0).fill('hsv', 180, 100, 100);
...
r.on('mousemove', function(mouse) {
  ...
  square2.fill('hsv', hue + 180, 100, 100);
});
