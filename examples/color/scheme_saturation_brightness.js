---
layout: example
title: "Color scheme: Saturation and brightness"
description: "Creating a color scheme using saturation and brightness with HSV"
---
...
r.on('mousemove', function(mouse) {
  ...
  square2.fill('hsv', hue, 100, 100).vars.fill.darken(0.3).desaturate(0.5);
  square3.fill('hsv', hue, 100, 100).vars.fill.darken(0.6).desaturate(0.2);
});
